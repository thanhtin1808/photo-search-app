package com.android.photosearch.data.remote.adapters.errors

import com.android.photosearch.data.remote.adapters.mappers.toThrowable
...
internal class ErrorHandlingCallback<R>(
    ...
    override fun onFailure(call: Call<R>, throwable: Throwable) {
        when (throwable) {
            ...
            -> delegate.onFailure(call, NoConnectionException())
